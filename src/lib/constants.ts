...
export enum PermissionsEnum {
  MANAGE_ROLES_CREATE = "manage_roles:create",
  MANAGE_ROLES_DELETE = "manage_roles:delete",
  MANAGE_ROLES_EDIT = "manage_roles:edit",
  MANAGE_ROLES_VIEW = "manage_roles:view",
  LEADS_DELETE = "leads:delete:all",
  ASSIGN_MEETINGS = "assign_records:meetings",
  TASKS_DELETE = "tasks:delete:",
  ASSIGN_LEADS = "assign_records:leads",
  INDIVIDUAL_EMAIL_LIMIT = "individual_email_limit",
  BULK_ASSIGN_LEADS = "bulk_assign_records:leads",
  ACCESS_ADMIN_SETTINGS = "access_admin_settings",
  CREATE_MEETINGS = "create_records:meetings",
  MEETINGS_EDIT = "meetings:edit:",
  BULK_UPDATE_TASKS = "bulk_update_records:tasks",
  MANAGE_USERS = "manage_users",
  SEARCH_LEADS = "search_records:leads",
  MERGE_MEETINGS = "merge_records:meetings",
  MEETINGS_VIEW = "meetings:view:",
  BULK_ASSIGN_MEETINGS = "bulk_assign_records:meetings",
  BULK_EMAIL_LIMIT = "bulk_email_limit",
  MERGE_LEADS = "merge_records:leads",
  BULK_UPDATE_MEETINGS = "bulk_update_records:meetings",
  MERGE_TASKS = "merge_records:tasks",
  CREATE_TASKS = "create_records:tasks",
  SEARCH_MEETINGS = "search_records:meetings",
  MEETINGS_DELETE = "meetings:delete:",
  LEADS_UPDATE = "leads:edit:all",
  VIEW_EMAIL_CONVERSATIONS = "view_email_conversations",
  TASKS_VIEW = "tasks:view:",
  BULK_ASSIGN_TASKS = "bulk_assign_records:tasks",
  TASKS_EDIT = "tasks:edit:",
  SEARCH_TASKS = "search_records:tasks",
  MANAGE_ALL_TAGS = "manage_all_tags",
  ASSIGN_TASKS = "assign_records:tasks",
  BULK_UPDATE_LEADS = "bulk_update_records:leads",
  LEADS_VIEW = "leads:view:all",
  LEADS_UPDATE_OWNED = "leads:edit:owned",
  LEADS_DELETE_OWNED = "leads:delete:owned",
