...
const mockLead = {
  ...
  date: "2022-11-30",
  tags: ["Ad Sk Re-assigned Leads", "Migrated_Lead"],
  createdAt: "2022-11-30T12:19:00",
  lastActivity: {
    type: "Email",
    date: "2022-11-30T12:19:00",
  }
};
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <div className="font-medium">{lead.lastActivity?.type}</div>
...
export default LeadDetailsEnhanced;
